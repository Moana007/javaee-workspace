	...
	<div id="addEmploye">
		...
		<form action="" name="" method="POST">
			...
			<div class="form-group" style="margin-top:15px;">
				<div class="input-group-text" style="display:inline-block;">Service</div>
				<select class="form-control" style="width:86%;display:inline-block;" name="selectService" id="selectService">
