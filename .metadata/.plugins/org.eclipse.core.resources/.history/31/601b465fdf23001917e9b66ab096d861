...
public class AddEmployeServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if( nom.isEmpty() || prenom.isEmpty() || salaire.isEmpty()) {
			...
			if(insertOK) {
				request.setAttribute("message", "<div class=\"alert alert-success\" role=\"alert\">Employé "+nom+" "+prenom+" ajouté avec succés</div><br><a href=\"./accueil\">Retour à l'acceuil</a>");
			} else {
